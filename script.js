...
const sleep_button = document.getElementById("sleep-button");
...
var settings = {
   "do_new_day_alert": false,
   "do_task_complete_alert": false,
   "do_not_enough_time_alert": false,
   "do_new_season_warning_alert": false,
   "do_damage_alert": false,
};
...
var daily_objectives = [
   ...
   ["Preserve meat",[
      ["Preserve meat",[["Preserved meat",3]], 0.25, 15,[["Unpreserved meat",3]]]
   ],[[1,"100%"]],[]],
   ["Repair fencing",[
...
function update_inventory_list()
{
   ...
   {
      if(["Energy","Nourishment","Hydration","Animal nourishment"].includes(key))
      {
         inventory_list_text += "- " + key + " " + float_to_rounded_tenths_string(value) + "%<br>";
      }
      else if(["Egg","Chick","Calf","Cattle","Chicken","Dying cattle","Dying chicken","Disrepaired fencing","Harvested crops"].includes(key))
      {
